...
const TEXTOS = {
  pt: {
    ...
    passo1_t: "Escolha a sua queixa",
    passo1_d: "Diga o que o traz à urgência, a partir de uma lista ou por pesquisa.",
    ...
    comecar: "Iniciar avaliação",
    inicio_como: "Como funciona?",
    atalho_112_desc: "Emergência",
    atalho_112_aria: "Ligar 112, emergência médica",
    atalho_sns_desc: "Aconselhamento",
    atalho_sns_aria: "Ligar SNS 24, 808 24 24 24",
    selo_privacidade:
    ...
    qx_grupo_geral: "Adultos e situações gerais",
    qx_grupo_ped: "Bebés e crianças",
    ...
    pergunta_max: (m) => `no máximo ${m}`,
    progresso_aria: (n, m) => `Pergunta ${n} de, no máximo, ${m}`,
    ler_pergunta_aria: "Ouvir a pergunta em voz alta",
    triagem_avaliar: "A avaliar prioridade",
    prioridades: {
      P1: "Vermelho (emergente)",
      P2: "Laranja (muito urgente)",
      P3: "Amarelo (urgente)",
      P4: "Verde (pouco urgente)",
      P5: "Azul (não urgente)",
    },
    sim: "Sim",
    nao: "Não",
    ...
    res_intro: "Com base nas suas respostas:",
    ...
    loc_alterar:
      "Indique a zona onde está. Escolha o concelho e, se souber, a freguesia e o sítio. Também pode tentar de novo a localização automática.",
    loc_titulo: "Onde está?",
    loc_lbl_concelho: "Concelho",
    loc_lbl_freguesia: "Freguesia",
    loc_lbl_sitio: "Sítio ou zona",
    ...
    aconselhamento_titulo: "O que pode fazer",
    aconselhamento_nota:
      "Conselhos gerais enquanto aguarda ou se dirige à ajuda. Não substituem a avaliação de um profissional. Ferramenta de orientação, por validar clinicamente.",
    ler: "Ouvir",
    ler_aria: "Ouvir estes conselhos em voz alta",
    porque_titulo: "Porquê esta recomendação?",
    porque_nota:
      "Fatores considerados no cálculo, pela ordem em que pesaram. Ferramenta de orientação, por validar clinicamente.",
    ...
    hist_titulo: "Avaliações anteriores",
    hist_vazio: "Ainda não há avaliações guardadas neste dispositivo.",
    hist_privacidade: "Estas avaliações ficam guardadas apenas neste dispositivo. Não são enviadas para nenhum servidor e pode apagá-las quando quiser.",
    hist_apagar_tudo: "Apagar tudo",
    hist_apagar_um: "Apagar esta avaliação",
    hist_voltar: "Voltar ao início",
    hist_red_flag: "Sinais de emergência",
    hist_confirmar_apagar: "Apagar todas as avaliações guardadas neste dispositivo?",
    ...
    stat_agora: "agora",
    stat_carro: "de carro",
    stat_espera: "de espera",
    minutos_aprox: (m) => `~${m} min`,
    ver_mapa: "Ver no mapa",
    ocultar_mapa: "Ocultar o mapa",
  ...
  en: {
    ...
    passo1_t: "Choose your complaint",
    passo1_d: "Tell us what brings you in, from a list or by searching.",
    ...
    comecar: "Start assessment",
    inicio_como: "How does it work?",
    atalho_112_desc: "Emergency",
    atalho_112_aria: "Call 112, medical emergency",
    atalho_sns_desc: "Advice line",
    atalho_sns_aria: "Call SNS 24, 808 24 24 24",
    selo_privacidade:
    ...
    qx_grupo_geral: "Adults and general situations",
    qx_grupo_ped: "Babies and children",
    ...
    pergunta_max: (m) => `at most ${m}`,
    progresso_aria: (n, m) => `Question ${n} of at most ${m}`,
    ler_pergunta_aria: "Listen to the question read aloud",
    triagem_avaliar: "Assessing priority",
    prioridades: {
      P1: "Red (immediate)",
      P2: "Orange (very urgent)",
      P3: "Yellow (urgent)",
      P4: "Green (less urgent)",
      P5: "Blue (non-urgent)",
    },
    sim: "Yes",
    nao: "No",
    ...
    res_intro: "Based on your answers:",
    ...
    loc_alterar:
      "Tell us where you are. Choose the municipality and, if you know them, the parish and locality. You can also try automatic location again.",
    loc_titulo: "Where are you?",
    loc_lbl_concelho: "Municipality",
    loc_lbl_freguesia: "Parish",
    loc_lbl_sitio: "Locality or area",
    ...
    aconselhamento_titulo: "What you can do",
    aconselhamento_nota:
      "General advice while you wait or make your way to help. It does not replace assessment by a professional. Guidance tool, pending clinical validation.",
    ler: "Listen",
    ler_aria: "Listen to this advice read aloud",
    porque_titulo: "Why this recommendation?",
    porque_nota:
      "Factors considered in the calculation, in the order they weighed. Guidance tool, pending clinical validation.",
    enc_calculo: (hora, dia) =>
    ...
    hist_titulo: "Previous assessments",
    hist_vazio: "No assessments saved on this device yet.",
    hist_privacidade: "These assessments are stored only on this device. They are not sent to any server and you can delete them at any time.",
    hist_apagar_tudo: "Delete all",
    hist_apagar_um: "Delete this assessment",
    hist_voltar: "Back to start",
    hist_red_flag: "Emergency signs",
    hist_confirmar_apagar: "Delete all assessments saved on this device?",
    ...
    estado_aberto: "Open",
    estado_fechado: "Closed",
    stat_agora: "right now",
    stat_carro: "by car",
    stat_espera: "waiting",
    minutos_aprox: (m) => `~${m} min`,
    ver_mapa: "Show on map",
    ocultar_mapa: "Hide the map",
    horarios_titulo: "Opening hours",
    chip_km: (km) => `${km} km`,
