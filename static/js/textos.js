...
const TEXTOS = {
  pt: {
    ...
    un_km_tempo: (v) => `a ${v.km} km · ~${v.min} min de carro (estim.)`,
    alt_viagem: (min) => `~${min} min de carro`,
    viagem_nota: "Tempos de viagem estimados com uma rede simplificada de estradas da RAM (valores típicos, sem trânsito) — por validar.",
  ...
  en: {
    ...
    un_km_tempo: (v) => `${v.km} km away · ~${v.min} min by car (est.)`,
    alt_viagem: (min) => `~${min} min by car`,
    viagem_nota: "Travel times estimated with a simplified RAM road network (typical values, no traffic) — pending validation.",
